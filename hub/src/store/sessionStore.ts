...
export class SessionStore {
    ...
    updateSessionModes(id: string, permissionMode: string | undefined, modelMode: string | undefined, smartContinueEnabled?: boolean | undefined, collaborationMode?: string | undefined, model?: string | undefined): void {
        return updateSessionModes(this.db, id, permissionMode, modelMode, smartContinueEnabled, collaborationMode, model)
    }
}
